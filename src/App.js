...
function App() {
  ...
  return (
    <div className="App">
      <link href="https://fonts.googleapis.com/css2?family=Be+Vietnam+Pro:ital,wght@0,100;0,300;0,600;0,700;0,900;1,100&display=swap" rel="stylesheet"></link>
      <div className="side-menu">
        <h2 className="title-home">GỬITIẾTKIỆM</h2>
        <Link to="/" className={isActive?"link-active link":"link"}
        onClick={handleActive}
        >
          <img src={imgHomePage} className="side-menu__img-home img" alt=""/>
          <p className="btn side-menu__btn-home">Trang chủ</p>
        </Link>
        <Link to="/Taikhoan" className={isActive1?"link-active link":"link"}
        onClick={handleActive1}>
          <img src={imgWalletPage} className="side-menu__img-wallet img" alt=""/>
          <p className="btn side-menu__btn-wallet">Tài khoản</p>
        </Link>
        <Link to="/Guitietkiem" className={isActive2?"link-active link":"link"}
        onClick={handleActive2}> 
          <img src={imgTietKiemPage} className="side-menu__img-tietkiem img" alt=""/>
          <p className="btn side-menu__btn-tietkiem">Gửi tiết kiệm</p>
        </Link>
        <Link to="/Setting" className={isActive3?"link-active link":"link"}
        onClick={handleActive3}>
          <img src={imgLichSuPage} className="side-menu__img-lichsu img" alt=""/>
